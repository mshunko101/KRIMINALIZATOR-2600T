...
Буквально они могут отобразить, т.е кластеризировать данные поулчаемые из сенсора, обычно выделяется 7-11 кластеров, если выпить алкоголя то внезапно кластеров становится 4-6 но не на долго. Под кластерами я понимаю выделеные зоны многомерных выбросов.
